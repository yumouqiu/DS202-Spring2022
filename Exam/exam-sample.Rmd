...
Read the data [`sample-combined-pbp-stats.csv`](https://raw.githubusercontent.com/yumouqiu/DS202-Spring2022/main/Exam/sample-combined-pbp-stats.csv) from our course Github website. Please save the data as a csv file local on your computer and read in R by the code:
