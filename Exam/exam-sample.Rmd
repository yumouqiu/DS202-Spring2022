...
Read the data [`sample-combined-pbp-stats.csv`](https://raw.githubusercontent.com/yumouqiu/DS202-Spring2022/main/Exam/sample-combined-pbp-stats.csv) from our course Github website by using the code
```{r, message = FALSE, warning = FALSE}
A = read.csv("https://raw.githubusercontent.com/yumouqiu/DS202-Spring2022/main/Exam/sample-combined-pbp-stats.csv")
```
