...
In Canvas, submit an RMarkdown file with: 
  ...
  d. the question you want to investigate with its answers and conclusions;
  e. one paragraph commenting on the workflow;
  f. a html or pdf file of the final output.


Due date: You have time until Monday at 10 pm to submit the final RMmarkdown and html/pdf files.
